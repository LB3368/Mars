...
public class MarsExpedition {
    public MarsExpedition() {
        ...
        if (name.equalsIgnoreCase("Y")) {
            ...
            System.out.println("Too band you are team leader. You HAVE to go.");
        }

        System.out.println("How many people do you want on you expedition team? (Input an int number)");
